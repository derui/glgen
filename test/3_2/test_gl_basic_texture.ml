     ...
     Gl.create_context window >>= (fun ctx ->
       ...
       begin
         ...
         tex_image2_d ~target:Ogl_enum.Texture_target.gl_texture_2d ~level:0
           ...
           ~width:(Types.Surface.w tex) ~height:(Types.Surface.h tex)
           ~border:0 ~format:Ogl_enum.Pixel_format.gl_rgba ~typ:Ogl_enum.Pixel_typ.gl_unsigned_byte
           ~pixels:();

         tex_parameterf ~target:Ogl_enum.Texture_target.gl_texture_2d
           ~pname:Ogl_enum.Texture_paramter_name.gl_texture_min_filter
           ~param:(Int32.to_float Ogl_enum.Texture_min_filter.gl_linear);
         tex_parameterf ~target:Ogl_enum.Texture_target.gl_texture_2d
           ~pname:Ogl_enum.Texture_paramter_name.gl_texture_mag_filter
         ...
         let rec loop counter scale =
           if counter = 0 then ()
             ...
             begin
               ...
               bind_texture ~target:Ogl_enum.Enable_cap.gl_texture_2d ~texture:(A.get textures 0);
